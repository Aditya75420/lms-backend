...
const CourseDetails = () => {
  ...
  return courseData ? (
    ...
    justify-betwen md:px-36 px-8 md:pt-30 pt-20 text-left"
      >
        <div
      ...
      bg-gradient-to-b from-cyan-100/70"
        ...
        text-course-details-heading-small font-semibold text-gray-800"
          ...
          {/* review and ratings */}
          <div className="flex items-center space-x-2 pt-3 pb-1b text-sm">
          ...
          <p className="text-sm">
            Course by <span className="text-blue-600 underline">Byjus</span>
          </p>
